...
plt.title("MLP Classifier ROC Curves (One-vs-Rest)")
...
importances = np.abs(clf.coefs_[0]).mean(axis=1) if len(clf.coefs_) > 0 else None
if importances is not None:
    ...
    plt.title("Top 20 Features by Mean Absolute Input Layer Weights")
    plt.show()
