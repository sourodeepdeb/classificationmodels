...
kernel = C(1.0) * RBF()
clf = GaussianProcessClassifier(kernel=kernel, random_state=42, n_restarts_optimizer=2, max_iter_predict=1000)
...
plt.title("GPR Coupling Agent Category Prediction Confusion Matrix")
plt.show()
